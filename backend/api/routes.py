...
async def enhance_documentation(api_spec: dict, ai_engine: AIEngine = Depends(AIEngine)):
...
async def generate_test_cases(endpoint_info: dict, ai_engine: AIEngine = Depends(AIEngine)):
